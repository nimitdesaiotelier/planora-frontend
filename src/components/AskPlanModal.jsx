                    ...
                    {hasRows && (
                      <div className="ask-plan-export-actions">
                        <button
                          ...
                          type="button"
                          title={exportLoading ? "Exporting…" : "Download Excel"}
                          aria-label={exportLoading ? "Exporting Excel" : "Download Excel"}
                        ...
                        >
                          {exportLoading ? (
                            <span className="spinner ask-plan-export-spinner" aria-hidden />
                          ) : (
                            <svg
